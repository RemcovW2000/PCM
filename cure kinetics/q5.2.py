...
from q5 import A1 ,fraction_cured_120, fraction_cured_150, fraction_cured_180, dalpha_dt_120, dalpha_dt_150, dalpha_dt_180


def da_dt(A2, E2, m, n, alpha, T):
    R = 8.314  # J/(mol·K)
    term_1 = A1 * np.exp(-E2 / (R * T))
...
alpha_vals = np.linspace(0, 0.97, 1000)
dalpha_dt_vals = {}
...
if __name__ == "__main__":
    ...
    result = minimize(
        ...
        bounds=[(1e3, 1e10), (1000.0, 200000.0), (0.0, 5.0), (0.0, 5.0)]
    )
