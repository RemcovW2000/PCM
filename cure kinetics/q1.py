...
from resources.constants import START_TIME_120, START_TIME_150
...
def prepare_for_plotting(data: Dict[str, list[float]], start_time: float = 0.0) ->Dict[str, list[float]]:
    """
...
final_data_120 = prepare_for_plotting(data_120, start_time=START_TIME_120)
...
final_data_150 = prepare_for_plotting(data_150, start_time=START_TIME_150)
...
plt.title('Net Heat Flow vs. Time')
plt.legend()
plt.show()
